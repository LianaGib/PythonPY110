...
from .views import products_view, shop_view, products_page_view, cart_view, \
    cart_add_view, cart_del_view, cart_dec_view, coupon_check_view, delivery_estimate_view, \
...
urlpatterns = [
    ...
    path('cart/dec/<str:id_product>', cart_dec_view),
    path('coupon/check/<name_coupon>', coupon_check_view),
